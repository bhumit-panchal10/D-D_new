                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" name="email"
                                                            ...
                                                            maxlength="30" id="emailInput" placeholder="Enter Your Email"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            minlength="10" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
