        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('product_purchase.index') }}" class="btn btn-sm btn-primary">Back</a>
                </div>

                <div class="card-body">
                    <form action="{{ route('product_purchase.store') }}" method="post">
                        @csrf
...
$(document).ready(function () {
    ...
    $('#product_id').change(function () {
        ...
        if (productId) {
            const getLastPurchasesUrl = "{{ route('product_purchase.getLastPurchases', ':productId') }}";
            const url = getLastPurchasesUrl.replace(':productId', productId);
