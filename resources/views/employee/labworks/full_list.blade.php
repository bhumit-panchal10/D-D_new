                                    ...
                                    <tbody>
                                        @foreach ($labworks as $key => $labwork)
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Collected Button -->
                                                    <form action="{{ route('employee.labworks.collected', $labwork->id) }}" method="POST" class="d-inline collected-form">
                                                        @csrf
                                                    ...
                                                    <!-- Received Button -->
                                                    <form action="{{ route('employee.labworks.received', $labwork->id) }}" method="POST" class="d-inline received-form">
                                                        @csrf
