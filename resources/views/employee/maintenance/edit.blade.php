        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('employee.maintenance.index') }}" class="btn btn-sm btn-primary">Back</a>
                </div>

                <div class="card-body">
                    <form action="{{ route('employee.maintenance.update', $maintenance->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="text-end">
                            ...
                            <a href="{{ route('employee.maintenance.index') }}" class="btn btn-primary">Cancel</a>
                        </div>
                    </form>
                </div> 
            </div> 
