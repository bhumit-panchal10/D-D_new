...
<head>
    ...
    <meta charset="utf-8" />
    <title>D&D DENTAL CLINIC | Log Out </title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <img src="{{ asset('assets/images/logo5.png') }}" alt="" height="240">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4 text-center">
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('ClinicLogin') }}" class="btn btn-primary w-100">Sign In</a>
                                    </div>
                                </div>
                            </div>
                        </div>
