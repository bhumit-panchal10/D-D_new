                                        ...
                                        <td>
                                            @if (!$maintenance->repair_received_date)
                                                ...
                                                <button class="btn btn-sm btn-primary mark-received"
                                                    ...
                                                    data-item-name="{{ $maintenance->item_name }}"
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('maintenance.markAsReceived') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control numeric-only" name="pay_due_amount"
                                id="pay_due_amount" maxlength="10" required>
                        </div>

                        <div class="mb-3">
                            <label>Received Comment</label><span class="text-danger">*</span>
                            <textarea class="form-control" name="received_comment" id="received_comment" rows="3" maxlength="255"
                                required></textarea>
                        </div>
